...
- prosty przebieg codziennej pracy: oznaczenie całej brygady, poprawienie wyjątków i uruchomienie gotowej pozycji planu jednym przyciskiem,
- możliwość cofnięcia ostatniej zmiany obecności, planu, pracy, zgłoszenia, problemu lub wydania materiału bez szukania rekordu,
...
- ścisłe rozdzielenie ekranów: szczegóły obecności są tylko w „Liście obecności”, wykonanie tylko w „Pracach”, wyniki tylko w „Wynikach”, a widok łączący priorytety znajduje się wyłącznie w „Podsumowaniu”,
